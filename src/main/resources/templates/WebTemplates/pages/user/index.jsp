		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li><a href="base/goto/user/selectRoomList.html" target="myiframe" class="dropdown-toggle"> <i class="icon-desktop"></i>
							<span class="menu-text"> 查看房间 </span> <b
							class="icon-double-angle-right"></b>
					</a></li>
					
					<li><a href="base/goto/user/selectCartList.html" target="myiframe" class="dropdown-toggle"> <i class="icon-desktop"></i>
							<span class="menu-text"> 购物车 </span> <b
							class="icon-double-angle-right"></b>
					</a></li>
					...
					<li><a class="dropdown-toggle"> <i class="icon-edit"></i>
						...
						<ul class="submenu">
							<li><a href="base/goto/user/selectOrderList.html" target="myiframe"> <i
			...
			<div class="main-content" style="width: 85%;">
				...
				<iframe style="text-align:center;" name="myiframe" frameborder="0"
					width="100%" height="100%" src="base/goto/user/selectRoomList.html"></iframe>
			</div>
			<!-- /.main-content -->
