...
<script type="text/javascript">
	function loginForm(form){
		return request({
			url: "#tolowercase($entity)/login.html",
			form: form,
			success:function(data){
				window.location.href = "#tolowercase($entity)/index.html";
			},
			isMultipart: false,
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" name="${cfg.loginUsercolumn}" class="form-control"
														placeholder="账号" /> <i class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" name="${cfg.loginPwdcolumn}" class="form-control"
							...
							<div id="forgot-box" class="forgot-box widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="registId">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" name="${cfg.loginUsercolumn}" placeholder="用户名" />
									...
									<script type="text/javascript">
										function register(){
											return request({
												url: "#tolowercase($entity)/regist.html",
												form: "registId",
												success: function(data){
													alert('注册成功！');
													window.location.href = "#tolowercase($entity)/index.html";
